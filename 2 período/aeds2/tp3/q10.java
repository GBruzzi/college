...
public class q10  {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvPath))) {
            ...
            System.err.println("erro ao abrir " + csvPath);
        } catch (IOException e) {
        ...
        String conteudo = "813584" + "\t" + comp + "\t" + mov + '\t' + executionTime + "ms";

        try (BufferedWriter writer = new BufferedWriter(new FileWriter("813584_quicksort3.txt"))) {

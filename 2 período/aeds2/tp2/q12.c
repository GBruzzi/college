...
// Função BubbleSort
void bubbleSort(Pokemon pokedex[], int n, int comp[], int mov[]) {
    for (int i = 0; i < n - 1; i++) {
...
int main () {
    ...
    // txt
    FILE *arquivo = fopen("813584_bolha.txt", "w"); 
    if (arquivo == NULL) {
        printf("Erro ao abrir o arquivo!\n");
        return 1;
    }

    // Escreve a matrícula, tempo de execução e número de comparações 
